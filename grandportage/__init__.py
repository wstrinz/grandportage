...
an artifact does not carry its own license to conclude.  This computes which claims remain
licensed after a step under available evidence, and refuses unsupported conclusions.
"""
